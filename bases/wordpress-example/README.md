# Copied repo: https://github.com/kubernetes-sigs/kustomize

It was copied from the describe repo, just not to face timeouts using Kustomize with remote resources.
